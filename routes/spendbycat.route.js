...
app.get('/spendbycat', (req, res) => {
    ...
    async.parallel( stackfunctionsSearch, function(err,result){
        ...
        res.render('spendbycat',{select_categories: selCats, select_views: selViews, periods: views, cats:cats , user:  req.session.user, loggedin:true , index1_active: index1, index2_active: index2, index3_active: index3 ,index4_active: index4,index5_active: index5} );
